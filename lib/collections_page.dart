...
class _CollectionsPageState extends State<CollectionsPage> {
  ...
  List<Collection> _getSortedAndFilteredCollections() {
    ...
    if (_filterItemCount == 'Under 5 items') {
      ...
      filtered = filtered
          .where((c) => c.productCount >= 5 && c.productCount <= 10)
          .toList();
  ...
  List<Collection> _getPaginatedCollections(
      List<Collection> collectionsToShow) {
    ...
    return collectionsToShow.sublist(
        startIndex,
        endIndex > collectionsToShow.length
        ...
        builder: (BuildContext context) {
          return InkWell(
            ...
            child: Column(
              children: [
                Expanded(
                  // Makes image take available space
                  child: Image.asset(
                    collection.imageUrl,
                    fit: BoxFit.cover,
                    ...
                    errorBuilder: (context, error, stackTrace) {
                      return Container(
                        ...
                        child: const Icon(
                            Icons.image_not_supported), // Show error icon
                      );
                    },
                  ),
                ),
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(
                          color: Colors
                              .grey[600], // Subtle color for secondary info
                          fontSize: 14,
                        ),
                      ),
                    ],
  ...
  Widget build(BuildContext context) {
    final List<Collection> displayedCollections =
        _getSortedAndFilteredCollections();
                ...
                children: [
                  ...
                  DropdownButton<String>(
                    ...
                    items: const [
                      ...
                      DropdownMenuItem(
                          value: 'Item Count: Low to High',
                          child: Text('Item Count: Low to High')),
                      DropdownMenuItem(
                          value: 'Item Count: High to Low',
                          child: Text('Item Count: High to Low')),
                      DropdownMenuItem(
                ...
                children: [
                  ...
                  DropdownButton<String>(
                    ...
                    items: const [
                      ...
                      DropdownMenuItem(
                          value: 'Under 5 items', child: Text('Under 5 items')),
                      DropdownMenuItem(
                          value: '5-10 items', child: Text('5-10 items')),
                      DropdownMenuItem(
                          value: 'Over 10 items', child: Text('Over 10 items')),
                    ],
                    onChanged: (value) {
                      if (value != null) {
                        setState(() {
            ...
            : Column(
                children: [
                  ...
                  GridView.builder(
                    ...
                    itemCount:
                        _getPaginatedCollections(displayedCollections).length,
                    itemBuilder: (context, index) {
                      final paginatedCollections =
                          _getPaginatedCollections(displayedCollections);
